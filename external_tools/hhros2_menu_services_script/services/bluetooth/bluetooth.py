...
PID_FILE = os.path.join(BASE_DIR, "pids", "bluetooth.pid")
...
def main():
    ...
    print("\nBluetooth connection logger running.")
    print("Logging to:", LOG_PATH)
    print("按回车键退回主菜单选择停止蓝牙功能\n")
    ...
    try:
        ...
        try:
            ...
            print("清理 PID 文件失败：", e, file=sys.stderr)

...
MAIN_MENU_SCRIPT="$PROJECT_ROOT/external_tools/hhros2_menu_services_script/menu/main_menu.py"

if [ ! -f "$MAIN_MENU_SCRIPT" ]; then
    echo "错误: 未找到 RTC 菜单脚本: $MAIN_MENU_SCRIPT"
    exit 1
fi
